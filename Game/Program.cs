    ...
    internal static class Program
    {
        private static void Main(string[] args)
        {
            var levelOneData = new ListISquare
            {
                ...
                new Wall(new Position(0, 4)), new Empty(new Position(1, 4)), new Goal(new Position(2, 4)),
                new Empty(new Position(3, 4)), new Wall(new Position(4, 4)),
                new Wall(new Position(0, 5)), new Wall(new Position(1, 5)), new Wall(new Position(2, 5)),
                new Wall(new Position(3, 5)), new Wall(new Position(4, 5))
            };
